...
var accessTokenSecret = process.env.ACCESS_TOKEN_SECRET || "myAccessTokenSecret1234567890";

const Cryptr = require("cryptr");
global.cryptr = new Cryptr(process.env.CRYPTR_SECRET || "mySecretKey");
...
const uri = "mongodb+srv://<admin>:<1234>@maincluster.a6ixbuh.mongodb.net/?retryWrites=true&w=majority&appName=MainCluster";
...
http.listen(port, function () {
	...
	mongoClient.connect("mongodb+srv://admin:1234@maincluster.a6ixbuh.mongodb.net/", {
